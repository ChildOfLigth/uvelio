...
import weddingRing from "@imgs/ringWithoutInlay.png";
...
export default function Main() {
  ...
  return (
    <>
        ...
        <div className="flex items-center justify-start relative w-[90%] m-auto">
          <div className="flex flex-col items-start justify-center gap-6 relative w-[47%] text-white">
            <h1 className="inlinetext-white font-medium text-[90px]">
              Get a begger, brighter gold at 1/4 the cost
            </h1>
            <p className="inline-block w-[60%] text-2xl">
              Enviromentally Concious and Ethically Sourced
            </p>
      ...
      {/* <div className="w-[90%] flex flex-col items-center justify-center gap-5 my-40 mx-auto">
        <div className="w-full grid grid-col-12 gap-5">
          <div className="bg-white rounded-(--border-radius) pt-5 flex flex-col items-start justify-between col-span-3">
            <h3 className="text-(--color-primary) text-[48px] text-center m-auto">
              Pings
            </h3>
            <img
              src={classicRing}
          ...
          <div className="bg-white rounded-(--border-radius) pt-5 flex flex-col items-start justify-end col-span-2">
            <h3 className="text-(--color-primary) text-[48px] text-center m-auto">
              Wedding rings
            </h3>
            <img
          ...
          <div className="flex flex-col items-center gap-5 col-span-4">
            <div className="bg-white w-full rounded-(--border-radius) flex items-center justify-start pr-5">
              <img
                src={ringWithInlay}
                alt="Ring with insert"
                className="w-45% aspect-squere "
              />
          ...
          <div className="flex items-center justify-between w-[15.7%] min-w-50.75 ">
            <button
              className="bg-(--color-primary) flex items-streetch  

...
export default function HeaderOnSmallSizes() {
  ...
  return (
    <div className="flex items-center justify-between w-[93%] h-18">
      {hidingSearchForm ? (
        <>
          <img
            src={uvelioLogo}
          ...
          <div className="w-1/2 min-w-50 h-[65%] flex items-center">
            <button
        ...
        <div className="flex items-center w-full gap-3">
          <form
            ...
            className="flex items-center justify-between w-[94%] h-[70%] bg-white rounded-(--border-radius) pt-3 pb-3 pl-4 pr-4"
          >
            <input
              type="text"
